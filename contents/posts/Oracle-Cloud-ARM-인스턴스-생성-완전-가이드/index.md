...
update: "2026-01-21T02:31:00.000Z"
date: "2026-01-20"
상태: "Ready"
...
## 2. (Option) Pay As You Go 업그레이드
        ...
        🎯 목적: 인스턴스 생성 우선권 확보 (Always Free 리소스는 여전히 무료)

PAYG 계정이 아니어도 무료 ARM A1 인스턴스 (4 OCPU + 24GB RAM)를 받을 수 있습니다. 
...
## 3. Budget Alert 설정 (유료 계정 전환의 경우 필수)
        ...
        ⚠️ 반드시 설정하세요! 예상치 못한 과금 방지

사용량만큼 과금이 되는데, 해당 서버 사양은 무료가 맞지만 정말 혹시! 과금이 발생할 수 있으니 알람 설정을 해둡니다. 
...
유료 계정이어도 "Out of Capacity" 에러가 발생할 수 있습니다. 이를 위해 5분마다 생성을 재시도하는 스크립트입니다.
        ...
        이 스크립트는 ~/.oci/config 설정을 자동으로 읽어오며 SSH 키도 자동 생성합니다.
